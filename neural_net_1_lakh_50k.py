...
train = pd.read_csv("edited_train.csv")[:404290]

 #---------------------------------------------------------------- Change the indices of the rows to be used for testing -----------------------------------------------------------#
 
test = pd.read_csv("test.csv")[:100000]
...
'''
#random.shuffle(ls)
#train_cc=train.loc[ls[:300000],:]
#test_cc=train.loc[ls[300000:],:]
